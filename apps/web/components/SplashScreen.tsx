      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center text-center px-4">
        ...
        >
          <div className="relative mx-auto h-28 w-28 sm:h-32 sm:w-32 md:h-36 md:w-36">
            ...
            {/* Neon plate */}
            <div className="absolute inset-6 rounded-2xl bg-black/35 border border-white/10 backdrop-blur-md shadow-[0_0_70px_rgba(52,211,153,0.30)] flex items-center justify-center">
        ...
        >
          ...
          <div className="mt-4 flex items-center justify-center gap-4">
            <div className="h-[2px] w-14 sm:w-20 bg-gradient-to-r from-transparent to-emerald-300/70 rounded-full" />
            ...
            <div className="h-[2px] w-14 sm:w-20 bg-gradient-to-l from-transparent to-cyan-300/70 rounded-full" />
          </div>
